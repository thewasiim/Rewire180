...
async function seedDatabase() {
  ...
  const defaultContent = [
    ...
    { key: 'skills_btn_2', value: '#method-pricing', type: 'text', label: 'Skills Card 2 Button Link', section: 'skills' },
    {
      ...
      section: 'skills',
      value: [
        { video: 'src/assets/videos/hero-video.mp4', text: 'Follow this step-by-step system to build a strong body and unstoppable confidence.', btn_link: '#vip-pricing' },
        { video: 'src/assets/videos/hero-video.mp4', text: 'Learn how to stay consistent, disciplined, and mentally sharp for life.', btn_link: '#method-pricing' }
      ]
    },
